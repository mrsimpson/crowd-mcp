...
describe("Streamable HTTP MCP Server - End-to-End Integration", () => {
  ...
  it.skipIf(!dockerAvailable)(
    "should handle MCP initialize request via streamable HTTP",
    async () => {
  ...
  it.skipIf(!dockerAvailable)(
    "should handle tools/list request via streamable HTTP",
    async () => {
      ...
      const toolNames = responseData.result.tools.map(
  ...
  it.skipIf(!dockerAvailable)(
    "should establish SSE stream via GET request",
    async () => {
  ...
  it.skipIf(!dockerAvailable)(
    "should handle session termination via DELETE",
    async () => {
  ...
  it.skipIf(!dockerAvailable)(
    "should handle active connections tracking",
    async () => {
